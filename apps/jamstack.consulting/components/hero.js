...
import doggo from "../public/lonely-doggo.png";
import Image from "next/image";

export default function Example() {
  return (
    <div className="bg-white sm:pb-12 lg:pb-12">
      <div className="overflow-hidden sm:pt-12 ">
        <div className=" lg:max-w-7xl lg:grid lg:grid-cols-2">
          <div>
            <div className="mt-20 relative z-10">
              ...
              <div className="mt-6 sm:max-w-xl">
                ...
                <p className="mt-6 text-xl text-gray-500">
                  We build things for the web that people enjoy using.
                </p>
              </div>
          ...
          <div className="sm:mx-auto sm:max-w-3xl sm:px-6">
            <div className="py-12 sm:relative sm:mt-12 sm:py-16 lg:relative lg:right-0 lg:max-w-sm">
              <div className="hidden sm:block">
                <div className="absolute inset-y-0 left-1/2 w-screen bg-gray-50 rounded-l-3xl lg:left-80 lg:right-0 lg:w-full" />
                <svg
                  className="absolute -top-40 -left-40 -mr-3 lg:m-0 z-0"
                  width={404}
                  height={392}
                  fill="none"
                  viewBox="0 0 404 392"
